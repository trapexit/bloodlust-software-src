...
//signed int (*volume_table)[VOLUMES][256];
    volume_table = (signed int (*)[VOLUMES][256])malloc(VOLUMES * 256 * sizeof(signed int));
...
//static unsigned char (*clip_8_buf)[256*VOICES];
    ...
    clip_8_buf = (unsigned char (*)[256*VOICES])malloc(256*VOICES);
    clip_8     = (unsigned char (*)[256*VOICES])   ((unsigned char *)clip_8_buf + 128*VOICES);
